...
public:
    ...
    ParserReturnCode Parse (double *return_token, Nonterminal::Name nonterminal_to_parse = Nonterminal::root);
...
#line 300 "calculator_parser.hpp"
...
private:
    ...
    void ThrowAwayTokenData_ (double const &token_data) throw();
...
private:
    ...
    struct RealizedState_
    {
        ...
        void                StealTokenStackTop                  (double *&return_token);
    ...
    private:
        ...
        {
            // If this is a Terminal (anything between 0 and Terminal::LOG)
            // that isn't ERROR_, then it's scanner-generated (i.e. not parser-generated).
            return token_id != Terminal::ERROR_ && token_id <= Terminal::LOG;
        }
...
#line 898 "calculator_parser.hpp"
