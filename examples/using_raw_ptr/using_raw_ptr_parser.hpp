...
// using_raw_ptr_parser.hpp generated by trison
// from using_raw_ptr_parser.trison using trison.cpp.targetspec and trison.cpp.header.codespec
// DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY
...
#line 18 "../using_raw_ptr_parser.trison"
...
#line 31 "../using_raw_ptr_parser.hpp"
...
/// this file was generated.  Specifically, the primary source is using_raw_ptr_parser.trison.
///
...
public:
    ...
    struct Token
    {
        ...
        Token (Id id) : m_id(id), m_data(nullptr) { }
...
public:
    ...
    ParserReturnCode Parse (Base * *return_token, Nonterminal::Name nonterminal_to_parse = Nonterminal::root);


#line 28 "../using_raw_ptr_parser.trison"
...
#line 331 "../using_raw_ptr_parser.hpp"
...
private:
    ...
    private:
        ...
        {
            // If this is a Terminal (anything between 0 and Terminal::LEAF)
            // that isn't ERROR_, then it's scanner-generated (i.e. not parser-generated).
            return token_id != Terminal::ERROR_ && token_id <= Terminal::LEAF;
        }
...
#line 47 "../using_raw_ptr_parser.trison"


#line 983 "../using_raw_ptr_parser.hpp"
