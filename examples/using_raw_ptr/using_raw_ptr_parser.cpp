...
// using_raw_ptr_parser.cpp generated by trison
// from using_raw_ptr_parser.trison using trison.cpp.targetspec and trison.cpp.implementation.codespec
// DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY
...
#line 51 "../using_raw_ptr_parser.trison"
...
#line 29 "../using_raw_ptr_parser.cpp"
...
#line 60 "../using_raw_ptr_parser.trison"

    m_recoverable_error_encountered = false;

#line 46 "../using_raw_ptr_parser.cpp"
}
...
#line 63 "../using_raw_ptr_parser.trison"


#line 59 "../using_raw_ptr_parser.cpp"
}
...
#line 97 "../using_raw_ptr_parser.trison"

    m_recoverable_error_encountered = false;

#line 86 "../using_raw_ptr_parser.cpp"
}

Parser::ParserReturnCode Parser::Parse (Base * *return_token, Nonterminal::Name nonterminal_to_parse)
{

#line 65 "../using_raw_ptr_parser.trison"


#line 95 "../using_raw_ptr_parser.cpp"
...
#line 82 "../using_raw_ptr_parser.trison"
...
#line 146 "../using_raw_ptr_parser.cpp"
...
#line 89 "../using_raw_ptr_parser.trison"

    std::cout << "Executing throw_away_token_actions on " << token_data << '\n';
    delete token_data;

#line 443 "../using_raw_ptr_parser.cpp"
}
...
#line 93 "../using_raw_ptr_parser.trison"

    assert(m_scanner != nullptr);
    return m_scanner->Scan();

#line 484 "../using_raw_ptr_parser.cpp"
...
Parser::Token::Data Parser::ExecuteReductionRule_ (std::uint32_t const rule_index_, TokenStack_ &token_stack_, Token const *lookahead_) throw()
{
    ...
    switch (rule_index_)
    {
        ...
        case 0:
        {
            ...
            Tree * el(static_cast<Tree *>(std::move(token_stack_[token_stack_.size()-2].m_data)));

#line 120 "../using_raw_ptr_parser.trison"

        return el;
    
#line 1383 "../using_raw_ptr_parser.cpp"
            break;
        }
        ...
        {
            assert(Grammar_::ms_rule_table_[rule_index_].m_token_count < token_stack_.size());
            Base * leaf(std::move(token_stack_[token_stack_.size()-1].m_data));

#line 128 "../using_raw_ptr_parser.trison"

        return leaf;
    
#line 1396 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 133 "../using_raw_ptr_parser.trison"

        return el;
    
#line 1409 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 138 "../using_raw_ptr_parser.trison"

        record_recoverable_error("unterminated parenthesized expression list");
        return el;
    
#line 1423 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 144 "../using_raw_ptr_parser.trison"

        record_recoverable_error("parse error in parenthesized expression");
        return new Tree();
    
#line 1436 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 150 "../using_raw_ptr_parser.trison"

        record_recoverable_error("unterminated parenthesized expression");
        return new Tree();
    
#line 1449 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 156 "../using_raw_ptr_parser.trison"

        record_recoverable_error("unexpected ')' in expression");
        return new Tree();
    
#line 1462 "../using_raw_ptr_parser.cpp"
            break;
        }
        ...
        case 7:
        {
            assert(Grammar_::ms_rule_table_[rule_index_].m_token_count < token_stack_.size());
            Tree * el(static_cast<Tree *>(std::move(token_stack_[token_stack_.size()-2].m_data)));
            Base * e(std::move(token_stack_[token_stack_.size()-1].m_data));

#line 165 "../using_raw_ptr_parser.trison"

        el->append(e);
        return el;
    
#line 1477 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 171 "../using_raw_ptr_parser.trison"

        record_recoverable_error("parse error in expression_list");
        return el;
    
#line 1491 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 177 "../using_raw_ptr_parser.trison"

        return new Tree();
    
#line 1503 "../using_raw_ptr_parser.cpp"
            break;
        }
...
#line 67 "../using_raw_ptr_parser.trison"
...
#line 2898 "../using_raw_ptr_parser.cpp"
