...
// CalcParser.hpp generated by trison
// from CalcParser.trison using trison.cpp.targetspec and trison.cpp.header.codespec
// DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY
...
/// this file was generated.  Specifically, the primary source is CalcParser.trison.
///
...
public:
    ...
    enum ParserReturnCode : std::uint32_t
    {
        ...
        PRC_INTERNAL_ERROR
    }; // end of enum CalcParser::ParserReturnCode

    /// "Namespace" for CalcParser::Terminal::Name, which enumerates all valid
    ...
    struct Terminal
    {
        ...
        ///
        /// CalcParser::Terminal::END_ should be returned in %target.cpp.scan_actions
        /// by the client when the input source has reached the end of input.  The parser
        /// will not request any more input after CalcParser::Terminal::END_ is received.
        ///
        /// CalcParser::Terminal::ERROR_ should not ever be used by the client, as
        ...
        enum Name
        {
            ...
            NUM = 258,
            BAD_TOKEN = 259
        }; // end of enum CalcParser::Terminal::Name
    }; // end of struct CalcParser::Terminal

    /// "Namespace" for CalcParser::Nonterminal::Name, which enumerates all nonterminals.
    ...
    struct Nonterminal
    {
        ...
        enum Name
        {
            ...
            stmt = 261,
            expr = 262
        }; // end of enum CalcParser::Nonterminal::Name
    }; // end of struct CalcParser::Nonterminal

    /// @brief Return type for %target.cpp.scan_actions.
    ///
    /// The client should package-up and return a CalcParser::Token from
    ...
    struct Token
    {
        ...
        typedef std::shared_ptr<Ast::Base> Data;
...
public:
    ...
    /// @return CalcParser::PRC_SUCCESS if the parse was successful (which includes
    ///         occurrences of parse errors which were handled by client-specified
    ///         %error-accepting rules), or CalcParser::PRC_UNHANDLED_PARSE_ERROR
...
private:
    ...
    struct Grammar_
    {
        ...
        struct Precedence_
        {
            ...
            char const *    m_name;
        }; // end of struct CalcParser::Grammar_::Precedence_
    ...
    struct Npda_
    {
        ...
        struct State_
        {
            ...
            char const *        m_description;
        }; // end of struct CalcParser::Grammar_::State_
        ...
        struct Transition_
        {
            ...
            }; // end of struct CalcParser::Grammar_::Transition_::Order
        }; // end of struct CalcParser::Grammar_::Transition_
    ...
    }; // end of struct CalcParser::Npda_
    ...
    }; // end of struct CalcParser::RealizedState_
    ...
    }; // end of struct CalcParser::HypotheticalState_
    ...
    struct ParseTreeNode_
    {
        ...
        struct Spec
        {
            ...
            }; // end of struct CalcParser::ParseTreeNode_::Spec::Order
        }; // end of struct CalcParser::ParseTreeNode_::Spec
        ...
        Token::Id LookaheadTokenId (CalcParser &parser) const;
        ...
        void Print (std::ostream &out, CalcParser const *parser, std::string const &prefix, std::uint32_t indent_level = 0, bool suppress_initial_prefix = false) const;
    }; // end of struct CalcParser::ParseTreeNode_
    ...
    friend std::ostream &operator << (std::ostream &stream, CalcParser::ParserReturnCode parser_return_code);
    friend std::ostream &operator << (std::ostream &stream, CalcParser::Token const &token);
}; // end of class CalcParser
