...
public:
    ...
    struct ParseNonterminal
    {
        ...
        enum Name
        {
            any_type_of_code_block = 170,
            at_least_one_newline = 164,
            at_least_zero_newlines = 162,
            bracketed_lookahead_terminal_list = 154,
            lookahead_terminal = 158,
            lookahead_terminal_list = 156,
            nonterminal = 136,
            nonterminal_specification = 138,
            nonterminals = 134,
            precedence_directive = 130,
            precedence_directives = 128,
            root = 0,
            rule = 142,
            rule_handler = 148,
            rule_handlers = 146,
            rule_precedence_directive = 160,
            rule_specification = 144,
            rule_token = 152,
            rule_token_list = 150,
            rules = 140,
            start_directive = 132,
            target_directive = 118,
            target_directive_param = 120,
            target_directives = 116,
            target_ids = 114,
            targets_directive = 112,
            terminal = 168,
            terminal_directive = 124,
            terminal_directives = 122,
            terminals = 126,
            token_id = 166,
            type_spec = 172,
...
private:
    ...
    struct Nonterminal_
    {
        enum Name
        {
            ...
            rule_token_list = 295,
            rule_token = 296,
            bracketed_lookahead_terminal_list = 297,
            lookahead_terminal_list = 298,
            lookahead_terminal = 299,
            rule_precedence_directive = 300,
            at_least_zero_newlines = 301,
            at_least_one_newline = 302,
            token_id = 303,
            terminal = 304,
            any_type_of_code_block = 305,
            type_spec = 306
