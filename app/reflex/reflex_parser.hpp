...
// reflex_parser.hpp generated by trison at Wed Jul 16 15:12:33 2008
...
#line 110 "reflex_parser.hpp"

/** A parser class generated by trison at Wed Jul 16 15:12:33 2008
  * from reflex_parser.trison using trison.cpp.targetspec and trison.cpp.header.codespec.
  *
...
public:
    ...
    struct Terminal
    {
        ...
        enum Name
        {
            ...
            BAD_TOKEN = 258,
            DIRECTIVE_MACRO = 259,
            DIRECTIVE_START_IN_SCANNER_MODE = 260,
            DIRECTIVE_STATE = 261,
...
private:
    ...
    struct Nonterminal_
    {
        enum Name
        {
            ...
            start_in_scanner_mode_directive = 278,
            scanner_modes = 279,
            scanner_mode = 280,
            scanner_mode_rules = 281,
            rule_list = 282,
            rule = 283,
            rule_handlers = 284,
            rule_handler = 285,
