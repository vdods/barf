...
#line 335 "reflex_parser.trison"
        ...
        try {
            ...
            {
                Regex::RegularExpression *regex = Dsc<Regex::RegularExpression *>(parser.GetAcceptedToken());
