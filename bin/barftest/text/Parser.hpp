...
#line 43 "../bin/barftest/text/Parser.hpp"
...
public:
    ...
    struct Terminal
    {
        ...
        enum Name
        {
            ...
            VOID_TYPE = 305,
            NULL_TYPE = 306,
            LLVM_CAST_KEYWORD = 307,
            STRING_LITERAL = 308,
            VALUE_KIND_SPECIFIER = 309,
            VALUE_LIFETIME_SPECIFIER = 310
    ...
    struct Nonterminal
    {
        ...
        enum Name
        {
            none_ = 0,
            root = 311,
            expression_then_end = 312,
            expression_then_lookahead_end = 313,
            parenthesized_expression = 314,
            parenthesized_expression_ender = 315,
            expression_tuple = 316,
            expression_tuple_ender = 317,
            expression_tuple_body = 318,
            expression_tuple_body_element = 319,
            expression_tuple_body_element_ender = 320,
            expression = 321,
            element_access_key_ender = 322,
            element_access_key_body_element = 323,
            element_access_key_body_element_ender = 324,
            parameter_list_ender = 325,
            parameter_list_body = 326,
            parameter_list_body_element = 327,
            parameter_list_body_element_ender = 328,
            function_literal = 329,
            function_prototype = 330,
            function_prototype_domain_declaration_tuple = 331,
            type_tuple = 332,
            type_tuple_ender = 333,
            type_tuple_body = 334,
            type_tuple_body_element = 335,
            type_tuple_body_element_ender = 336,
            type_expression = 337,
            function_type = 338,
            function_type_domain = 339,
            function_type_then_end = 340,
            symbol_specifier = 341,
            declaration_statement = 342,
            declaration_statement_type = 343,
            initialization_statement = 344,
            initialization_id = 345,
            initialization_statement_content = 346,
            definition_statement = 347,
            definition_symbol_specifier = 348,
            definition_statement_content = 349,
            assignment_statement = 350,
            assignment_target = 351,
            assignment_statement_content = 352,
            declaration_tuple = 353,
            declaration_tuple_ender = 354,
            declaration_tuple_body = 355,
            declaration_tuple_body_element = 356,
            declaration_symbol_specifier = 357,
            declaration_tuple_body_element_type = 358,
            declaration_tuple_body_element_ender = 359,
            statement_then_end = 360,
            statement = 361,
            statement_ender = 362,
            bracketed_statement_list = 363,
            bracketed_statement_list_ender = 364,
            statement_list_then_end = 365,
            statement_list = 366,
            lookahead_test_expression_then_end = 367,
            lookahead_test_expression = 368,
            id_list_then_end = 369,
            id_list = 370,
            parenthesized_id_list = 371
    ...
    struct Token
    {
        ...
        Token (Id id) : m_id(id), m_data(parser_static_move_cast<nnup<sem::Base>>(sem::make_dummy())) { }
...
public:
    ...
    ParserReturnCode Parse (nnup<sem::Base> *return_token, Nonterminal::Name nonterminal_to_parse = Nonterminal::root);


#line 37 "../bin/barftest/text/Parser.trison"
...
#line 456 "../bin/barftest/text/Parser.hpp"
...
private:
    ...
    private:
        ...
        {
            // If this is a Terminal (anything between 0 and Terminal::VALUE_LIFETIME_SPECIFIER)
            // that isn't ERROR_, then it's scanner-generated (i.e. not parser-generated).
            return token_id != Terminal::ERROR_ && token_id <= Terminal::VALUE_LIFETIME_SPECIFIER;
        }
