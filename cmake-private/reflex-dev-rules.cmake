...
function(reflex_add_source_dev SOURCE_FILE REFERENCE_OUTPUT_DIR DEV_OUTPUT_DIR TARGET_NAME)
    ...
    __reflex_add_source__impl(${PROJECT_BINARY_DIR}/bin/reflex ${SOURCE_DIR} ${SOURCE_BASENAME} FALSE ${PROJECT_BINARY_DIR} TRUE ${PROJECT_SOURCE_DIR}/targets ${DEV_OUTPUT_DIR} force_${TARGET_NAME} reflex)

    set(OUTPUT_FILES
        ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.cpp
        ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.hpp
        ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.dfa.dot
        ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.nfa.dot
    )

    add_custom_target(${TARGET_NAME} DEPENDS ${OUTPUT_FILES})
    set_property(TARGET ${TARGET_NAME} PROPERTY EXCLUDE_FROM_ALL TRUE)
    add_custom_target(clean_${TARGET_NAME} COMMAND rm -f ${OUTPUT_FILES} ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.dfa.png ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.nfa.png)
...
#             ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.hpp
    ...
    if(DEFINED DOXYGEN_DOT_EXECUTABLE)
        add_custom_target(${TARGET_NAME}_dfa_png DEPENDS ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.dfa.png)
        add_custom_target(clean_${TARGET_NAME}_dfa_png COMMAND rm -f ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.dfa.png)

        add_custom_target(${TARGET_NAME}_nfa_png DEPENDS ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.nfa.png)
        add_custom_target(clean_${TARGET_NAME}_nfa_png COMMAND rm -f ${DEV_OUTPUT_DIR}/${SOURCE_BASENAME}.nfa.png)
