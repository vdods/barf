...
function(trison_add_source_dev SOURCE_FILE TARGET_NAME)
    ...
    __trison_add_source__impl(${PROJECT_BINARY_DIR}/bin/trison ${SOURCE_DIR} ${SOURCE_BASENAME} TRUE ${PROJECT_SOURCE_DIR}/targets ${PROJECT_BINARY_DIR}/dev force_${TARGET_NAME})
