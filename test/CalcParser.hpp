...
//             m_state_index(std::uint32_t(-1)), // TODO: Should probably be ParseStackTreeNode_::UNUSED_DATA (or similar)
            m_token(Nonterminal::none_, std::shared_ptr<Ast::Base>())
        { }
...
//             return m_state_index == other.m_state_index;
    ...
    }; // end of struct CalcParser::RealizedBranchStackElement_
    ...
    }; // end of struct CalcParser::HypotheticalBranchStackElement_
    ...
    }; // end of struct CalcParser::Rule_
    ...
    struct State_
    {
        ...
        char const *m_description;
    }; // end of struct CalcParser::State_
    ...
    }; // end of struct CalcParser::Transition_
    ...
    struct ParseStackTreeNode_
    {
        ...
        void Print (std::ostream &out, CalcParser const &parser, std::string const &prefix, std::uint32_t indent_level = 0) const;
    };
