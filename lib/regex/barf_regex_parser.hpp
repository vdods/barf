...
#line 311 "barf_regex_parser.hpp"
...
private:
    ...
    Token::Data ExecuteReductionRule_ (std::uint32_t const rule_index_, TokenStack_ const &token_stack);
...
#line 941 "barf_regex_parser.hpp"
