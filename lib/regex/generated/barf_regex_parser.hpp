...
private:
    ...
    Token::Data ExecuteReductionRule_ (std::uint32_t const rule_index_, TokenStack_ const &token_stack, Token const *lookahead_);
...
#line 1015 "../lib/regex/generated/barf_regex_parser.hpp"
