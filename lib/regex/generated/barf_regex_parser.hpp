...
public:
    ...
    struct Nonterminal
    {
        ...
        enum Name
        {
            none_ = 0,
            regex_then_end = 263,
            regex_parenthesized = 264,
            regex_unterminated = 265,
            branch = 266,
            branch_which_didnt_just_accept_an_atom = 267,
            branch_which_just_accepted_an_atom = 268,
            atom = 269,
            bound = 270,
            bracket_expression = 271,
            bracket_char_set = 272,
            bracket_expression_char = 273,
            atom_control_char = 274,
            atom_normal_char = 275,
            bracket_expression_control_char = 276,
            bracket_expression_normal_char = 277,
            id = 278,
            integer = 279
...
#line 343 "../lib/regex/generated/barf_regex_parser.hpp"
...
private:
    ...
    ParserReturnCode Parse (Ast::Base * *return_token, Nonterminal::Name nonterminal_to_parse = Nonterminal::regex_then_end);
...
private:
    ...
    private:
        ...
        {
            // If this is a Terminal (anything between 0 and Terminal::HEX_CHAR)
            // that isn't ERROR_, then it's scanner-generated (i.e. not parser-generated).
            return token_id != Terminal::ERROR_ && token_id <= Terminal::HEX_CHAR;
        }
    ...
    Token::Data ExecuteReductionRule_ (std::uint32_t const rule_index_, TokenStack_ &token_stack, Token const *lookahead_);
    ...
    Token const &Lookahead_ (TokenQueue_::size_type index);
...
#line 1029 "../lib/regex/generated/barf_regex_parser.hpp"
