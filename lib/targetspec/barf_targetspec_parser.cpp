...
Parser::ParserReturnCode Parser::Parse_ (Ast::Base * *return_token_, ParseNonterminal::Name nonterminal_to_parse_)
{
    ...
    *return_token_ = NULL;
    ...
    assert((false
           || nonterminal_to_parse_ == ParseNonterminal::add_codespec
           || nonterminal_to_parse_ == ParseNonterminal::add_directive
           || nonterminal_to_parse_ == ParseNonterminal::at_least_one_newline
           || nonterminal_to_parse_ == ParseNonterminal::at_least_zero_newlines
           || nonterminal_to_parse_ == ParseNonterminal::default_value
           || nonterminal_to_parse_ == ParseNonterminal::directives
           || nonterminal_to_parse_ == ParseNonterminal::param_spec
           || nonterminal_to_parse_ == ParseNonterminal::root
           || nonterminal_to_parse_ == ParseNonterminal::target
           ) && "invalid nonterminal_to_parse_");
    m_stack_.push_back(StackElement_(nonterminal_to_parse_, NULL));
    TRISON_CPP_DEBUG_CODE_(std::cerr << 
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 95 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 106 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 151 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 170 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 178 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 245 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 265 "barf_targetspec_parser.cpp"
 << " current (relevant) lookahead(s):";)
                for (TrisonCpp_::Uint32 i = 0; i < tested_lookahead_count; ++i)
                {
                    TRISON_CPP_DEBUG_CODE_(std::cerr << ' ' << Lookahead_(i);)
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 307 "barf_targetspec_parser.cpp"
...
#line 90 "barf_targetspec_parser.trison"

    delete token_data;

#line 331 "barf_targetspec_parser.cpp"
}

Parser::Token Parser::Scan_ () throw()
{

#line 93 "barf_targetspec_parser.trison"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 417 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 434 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 466 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 488 "barf_targetspec_parser.cpp"
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 515 "barf_targetspec_parser.cpp"
...
#line 179 "barf_targetspec_parser.trison"
...
#line 537 "barf_targetspec_parser.cpp"
            break;
        }
...
#line 196 "barf_targetspec_parser.trison"
...
#line 212 "barf_targetspec_parser.trison"
 return NULL; 
#line 582 "barf_targetspec_parser.cpp"
            break;
        }
...
#line 608 "barf_targetspec_parser.cpp"
            break;
        }
...
#line 248 "barf_targetspec_parser.trison"
...
#line 663 "barf_targetspec_parser.cpp"
            break;
        }
...
#line 270 "barf_targetspec_parser.trison"
...
#line 295 "barf_targetspec_parser.trison"
...
#line 301 "barf_targetspec_parser.trison"

        delete throwaway;
        return new ParamType(Ast::AST_DUMB_CODE_BLOCK);
    
#line 738 "barf_targetspec_parser.cpp"
            break;
        }
...
#line 336 "barf_targetspec_parser.trison"
 return NULL; 
#line 836 "barf_targetspec_parser.cpp"
            break;
        }
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 853 "barf_targetspec_parser.cpp"
 << " parser stack: ";
...
#line 146 "barf_targetspec_parser.trison"
"Barf::TargetSpec::Parser (at " << GetFiLoc() << "): "
#line 874 "barf_targetspec_parser.cpp"
 << "    ";
    while (*string != '\0')
    {
        if (*string == '\n')
...
Parser::Transition_ const Parser::ms_transition_table_[] =
{
    ...
    { Parser::Transition_::TT_RETURN, 0, 0, ms_lookahead_table_+47 },
    ...
    { Parser::Transition_::TT_RETURN, 0, 0, ms_lookahead_table_+66 },
    ...
    { Parser::Transition_::TT_RETURN, 0, 0, ms_lookahead_table_+69 }
};
...
#line 1491 "barf_targetspec_parser.cpp"
